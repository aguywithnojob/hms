...
<html>
	...
	<body style="background-image: url(uploads/bg.jpg) !important;
    ...
    z-index: 1; width: 100%">
        ...
        <div class="navbar navbar-top navbar-inverse">
            ...
            <div class="navbar-inner" style="background: linear-gradient(to right, #3494E6 0%, #EC6EAD 90%) !important;">

                <div class="container-fluid">

                    <a class="brand" href="#">HOSPITAL NAME</a>
            ...
            <div class="span4 offset4">
                ...
                <div class="padded ">
                    ...
                    <center>
                       ...
                       <h1 style="margin-top: 20%; color: #155799;">HOSPITAL LOGO</h1>
                    ...
                    <div class="login box" style="margin-top: 10px;">
                        ...
                        <div class="box-header"  >
                            ...
                            <span class="title" style="margin-left: 38%; font-size: 20px; text-transform: uppercase; color: #159957;" ><?php echo get_phrase('login');?></span>
